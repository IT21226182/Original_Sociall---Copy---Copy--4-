...
export default function Questionnaire() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (lang === "sinhala") {
        setResult(riskPrediction === 1 ? "ඔබේ දරුවාට ඔටිසම් රෝගයට සම්බන්ධ සමාජ කුසලතා දුෂ්කරතා තිබේ, වැඩිදියුණු කිරීමේ ක්‍රියාකාරකම් පරීක්ෂා කරන්න" : "අවදානමක් නැත");
      } else if (lang === "tamil") {
        setResult(riskPrediction === 1 ? "ஆபத்து கண்டறியப்பட்டது" : "ஆபத்து கண்டறியப்படவில்லை");
      } else {
        setResult(riskPrediction === 1 ? "Your child has social skills difficulties related to autism, Checkout improvement activities" : "No Risk Detected");
      }
